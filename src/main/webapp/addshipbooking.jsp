...
<body>
	...
	<form>
		<body style="background-color: Cyan;">
			<img src="assets/images/shiip.jpg" width="500" height="200"
				alt="darbar" />
			<br>
			<br>Enter user_id :
			<input type="number" name="user_id" placeholder="Enter number"
				required />
			<br>Enter ship_id :
			<input type="number" name="ship_id" placeholder="Enter number"
				required />
			<br>Enter booking_ticket :
			<input type="number" name="booking_ticket" placeholder="Enter number"
				required min="1" max="5" />
			<br>select source_place:
			<select name="source_place">
				<option value="select">select</option>
				<option value="corals">corals</option>
				<option value="kaavaratti">kaavaratti</option>
				<option value="amindivi">amindivi</option>
			</select>
			<br>select destination_place:
			...
			<br>Enter classes :
			<input type="radio" name="classes" value="VIP" required>VIP
			...
			<img src="assets/images/ship.jpg" width="200" height="200"
				alt="darbar" />
			<br>

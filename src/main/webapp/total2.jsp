...
<body style="background-color: Cyan;">
	<form action="ordered2.jsp">
		total amount:<input type="number" name="amount" value="<%=amount%>"
			readonly> payment through:<br>
		<input type="radio" name="cash">credit card <br>
		<input type="radio" name="cash">net banking <br>
		<input type="radio" name="cash">wallet <br>
